        ...
        <footer className="footer">
          ...
          <div className="footer-inner footer-b footer-variant">
            ...
            <div className="footer-contact-grid">
              ...
              <div className="contact-item">
                <svg className="contact-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M21 15a4 4 0 0 1-4 4H7l-4 4V7a4 4 0 0 1 4-4h10a4 4 0 0 1 4 4v8Z" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
              ...
              <div className="contact-item">
                <svg className="contact-icon" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect x="7" y="12" width="6" height="4" stroke="currentColor" stroke-width="2"/>
                </svg>
